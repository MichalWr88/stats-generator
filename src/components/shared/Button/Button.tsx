...
const primaryClassName =
  'h-8 w-full my-3 p-2.5 bg-blue-600 text-gray-600 font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out';
...
const Button = (props: Props) => {
  ...
  return (
    <button
      ...
      type="button"
      onClick={() => (!props.disabled ? clickHandle : null)}
      {...rest}
    >
      {children}
    </button>
