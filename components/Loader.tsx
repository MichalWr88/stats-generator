...
const Loader = () => {
  ...
  if (isFetching || isMutating) {
    return (
      <div className="backdrop-blur-sm bg-white/30 fixed flex flex-wrap justify-center items-center modal fade  top-0 left-0  w-full h-full outline-none overflow-x-hidden overflow-y-auto z-10">
        <div
